...
# Устанавливаем заголовки HTTP-запроса, чтобы имитировать запрос от браузера и избежать блокировки
headers = {
    ...
    for i in range(5):
        ...
        for j in range(32):
            try:
                ...
                # Обновляем флаг data_added
                data_added = True

            except requests.RequestException as e:
                errors_occurred = True
                print(f"Ошибка при запросе страницы {link}: {e}")
            except AttributeError as e:
                errors_occurred = True
                print(f"Ошибка парсинга данных на странице {link}: {e}")
...
try:
    if data_added:
        ...
        print('Файл res5.json создан и заполнен данными.')
    else:
        print('Данные не были добавлены, файл не создан.')
except IOError as e:
