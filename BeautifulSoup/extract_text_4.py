...
<body>
    ...
    <p id="923874" class="120948">Asynchronous parsing – другой популярный фреймворк для веб-парсинга на Python.</p>
    ...
    <p id="384756" class="293487">Asynchronous parsing облегчает парсинг множества страниц и управление запросами.</p>
...
def sum_even_length_ids(html):
    ...
    for el in tag:
        ...
        print(el.text)
        print(el.string)
    even_numbered_text = sum([int(el.get('id')) + int(*el.get('class')) for el in tag if len(el.string.replace(' ', '')) % 2 == 0])
    print(f"Сумма ID и CLASS тегов <p> с чётной длиной текста без пробелов: {even_numbered_text}")
